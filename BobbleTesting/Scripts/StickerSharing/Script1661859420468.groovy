...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Stickers (2)'), 0)
...
Mobile.getText(findTestObject('Object Repository/android.widget.Button - DONE'), 0)
